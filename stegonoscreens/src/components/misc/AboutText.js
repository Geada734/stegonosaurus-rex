    ...
    const aboutText = {
        "en":
            <section className={classes.aboutText}>
                ...
                <p>
                    <span className={classes.note}>Note: </span> API calls are secured with JWT validation. If you plan to
                ...
                <ul>
                    <li>
                        <span className={classes.stress}>Transparent </span> mode will show the message on top of the original image in bright
                        red.
                    </li>
                    <li>
        ...
        <section className={classes.aboutText}>
            ...
            <p>
                <span className={classes.note}>Nota: </span> Las llamadas al API del servidor de Flask están aseguradas
